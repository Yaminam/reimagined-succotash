  ...
  return (
    <section className={styles.hero} aria-labelledby="hero-heading">
      ...
      <div className={`ll-container ${styles.content}`}>
        ...
        >
          Every spirit we make is a way of holding light, the amber of a whisky,
          the clarity of a gin, the glow of a champagne. This is a house seen
          through the way light moves through craft.
        </motion.p>
